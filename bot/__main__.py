...
botcmds = [
BotCommand(f'{BotCommands.MirrorCommand}', '✨'),
BotCommand(f'{BotCommands.TarMirrorCommand}','🔐'),
BotCommand(f'{BotCommands.UnzipMirrorCommand}','🔓'),
BotCommand(f'{BotCommands.CloneCommand}','💉'),
BotCommand(f'{BotCommands.WatchCommand}','🍿'),
BotCommand(f'{BotCommands.TarWatchCommand}','🔐'),
BotCommand(f'{BotCommands.CancelMirror}','🚫'),
BotCommand(f'{BotCommands.CancelAllCommand}','❌'),
BotCommand(f'{BotCommands.DeleteCommand}','🗑'),
BotCommand(f'{BotCommands.ListCommand}',' 🔎'),
BotCommand(f'{BotCommands.StatusCommand}','📑'),
BotCommand(f'{BotCommands.StatsCommand}','📃'),
BotCommand(f'{BotCommands.HelpCommand}','❔'),
BotCommand(f'{BotCommands.SpeedCommand}','⚡'),
